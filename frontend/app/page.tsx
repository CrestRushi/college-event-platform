...
export default function Home() {
  ...
  async function submit(event: FormEvent<HTMLFormElement>) {
    ...
    try { const response = await fetch(`${API}/api/registrations`, { method: 'POST', body: form }); const data = await response.json(); if (!response.ok) throw new Error(data.message); setSuccess(data); formElement.reset(); setDocumentName(''); load(); }
  ...
  function selectDocument(event: ChangeEvent<HTMLInputElement>) {
    ...
    if (!file) return setDocumentName('');
